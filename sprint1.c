...
int main() {
    ...
    do {
        ...
        //}
        if(batAtual >= batDesejada){
            printf("\n[ERRO] Valores invalidos! A carga final deve ser maior que a inicial.\n");

        }
        if(batAtual < 0 || batAtual > 100){
            printf("\n[ERRO] Valores invalidos! O valor deve ser entre 0 e 100\n");

        }
        if(batDesejada > 100){
            printf("\n[ERRO] Valores invalidos! O valor nao pode ser maior que 100\n");
